...
extern "C" void Java_mcgroup16_asu_com_group16_activity_DataCollectActivity_jniSvmTrain(JNIEnv *env, jobject obj, jstring cmdIn){
...
*/
extern "C" JNIEXPORT int JNICALL Java_mcgroup16_asu_com_group16_activity_DataCollectActivity_testInt(JNIEnv * env, jobject obj){
	return 5566;
}

extern "C" void Java_mcgroup16_asu_com_group16_activity_DataCollectActivity_testLog(JNIEnv *env, jobject obj, jstring logThis){
